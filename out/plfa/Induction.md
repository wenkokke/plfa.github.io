...
<pre class="Agda">{% raw %}<a id="25438" class="Comment">-- Your code goes here</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="25678" class="Comment">-- Your code goes here</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="25894" class="Comment">-- Your code goes here</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="26166" class="Comment">-- Your code goes here</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="26336" class="Comment">-- Your code goes here</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="26550" class="Comment">-- Your code goes here</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="26755" class="Keyword">data</a> <a id="Bin"></a><a id="26760" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Induction.md %}{% raw %}#26760" class="Datatype">Bin</a> <a id="26764" class="Symbol">:</a> <a id="26766" class="PrimitiveType">Set</a> <a id="26770" class="Keyword">where</a>
  <a id="Bin.nil"></a><a id="26778" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Induction.md %}{% raw %}#26778" class="InductiveConstructor">nil</a> <a id="26782" class="Symbol">:</a> <a id="26784" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Induction.md %}{% raw %}#26760" class="Datatype">Bin</a>
  <a id="Bin.x0_"></a><a id="26790" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Induction.md %}{% raw %}#26790" class="InductiveConstructor Operator">x0_</a> <a id="26794" class="Symbol">:</a> <a id="26796" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Induction.md %}{% raw %}#26760" class="Datatype">Bin</a> <a id="26800" class="Symbol">→</a> <a id="26802" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Induction.md %}{% raw %}#26760" class="Datatype">Bin</a>
  <a id="Bin.x1_"></a><a id="26808" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Induction.md %}{% raw %}#26808" class="InductiveConstructor Operator">x1_</a> <a id="26812" class="Symbol">:</a> <a id="26814" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Induction.md %}{% raw %}#26760" class="Datatype">Bin</a> <a id="26818" class="Symbol">→</a> <a id="26820" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Induction.md %}{% raw %}#26760" class="Datatype">Bin</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="27170" class="Comment">-- Your code goes here</a>{% endraw %}</pre>


## Standard library

Definitions similar to those in this chapter can be found in the standard library:
<pre class="Agda">{% raw %}<a id="27323" class="Keyword">import</a> <a id="27330" href="https://agda.github.io/agda-stdlib/v0.17/Data.Nat.Properties.html" class="Module">Data.Nat.Properties</a> <a id="27350" class="Keyword">using</a> <a id="27356" class="Symbol">(</a><a id="27357" href="https://agda.github.io/agda-stdlib/v0.17/Data.Nat.Properties.html#9375" class="Function">+-assoc</a><a id="27364" class="Symbol">;</a> <a id="27366" href="https://agda.github.io/agda-stdlib/v0.17/Data.Nat.Properties.html#9531" class="Function">+-identityʳ</a><a id="27377" class="Symbol">;</a> <a id="27379" href="https://agda.github.io/agda-stdlib/v0.17/Data.Nat.Properties.html#9272" class="Function">+-suc</a><a id="27384" class="Symbol">;</a> <a id="27386" href="https://agda.github.io/agda-stdlib/v0.17/Data.Nat.Properties.html#9708" class="Function">+-comm</a><a id="27392" class="Symbol">)</a>{% endraw %}</pre>
